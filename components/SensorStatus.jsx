    ...
    <div className="min-h-screen w-full bg-gray-50 px-6 py-10 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {grupos.map((grupo, grupoIndex) => (
          <div key={grupoIndex} className="group bg-white border border-gray-200 rounded-xl shadow-md p-5 space-y-4 transition-transform transform hover:scale-102 hover:shadow-md hover:border-gray-300">
            <div className="flex justify-between items-center">
            ...
            <div className="grid gap-4">
              {grupo.sensores.map((sensor) => (
                <div key={sensor.id} className="relative p-3 border rounded-lg bg-gray-50 hover:bg-gray-100 transition-all duration-300">
